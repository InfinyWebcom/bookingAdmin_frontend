  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      email: Yup.string()
        ...
        .trim(),
      contact : Yup.string('contact number must be').matches(/^[0-9 ]*$/, 'Please enter Valid VAT Number').min(10, 'VAT Number Must be of 10 digit').max(10, 'cannot be of more than 10 digit'),
    }),
