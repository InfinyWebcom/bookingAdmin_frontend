...
export default function Editowner(props) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      axios
        .patch(`${Appconfig.baseurl}/accounts/users`, partial_update, {
          headers: {
  ...
  const getOwner = async () => {
    ...
    let data = await axios.get(
      `${Appconfig.baseurl}/accounts/users?user_id=${user_id}`,
      {
        headers: {
          Authorization: "Token " + token,
        },
    ...
    setOwnerData(data.data.users[0]);
  };
                ...
                >
                  <div className="container px-4 mx-auto">
                    ...
                    <div className="flex flex-wrap">
                      ...
                      <div className="mb-3 w-full px-4 flex-6 lg:w-6/12 md:flex-none"></div>
                    </div>
                  </div>
